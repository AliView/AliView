...
import aliview.utils.FileDrop.TransferableObject;
...
public class FileDrop
{
				...
				else // this section will check for a reader flavor.
				{
					...
					for (int zz = 0; zz < flavors.length; zz++) {
						if (flavors[zz].isRepresentationClassReader()) {
							...
							if(listener != null)
								listener.filesDropped(createFileArray(br, out), evt);
	...
	public static interface Listener {
		 ...
		 * @since 1.0
		 */
		public abstract void filesDropped( java.io.File[] files , DropTargetDropEvent evt );
