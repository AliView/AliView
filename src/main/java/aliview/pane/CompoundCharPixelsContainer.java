...
public class CompoundCharPixelsContainer {
	...
	public static CompoundCharPixelsContainer createDefaultCompoundColorImpl(Font font, int minFontSize, int width, int height, ColorScheme colorScheme) {
	...
	public static CompoundCharPixelsContainer createSelectedCompoundColorImpl(Font font, int minFontSize, int width, int height, ColorScheme colorScheme) {
		...
		for(Color bgColor : colorScheme.getALLCompundColors()){
			...
			for(int n = 0; n < container.backend.length; n++){	
				...
				container.backend[n] = new CharPixels((char)n, width, height, fgColor, bgColor.darker(), font, minFontSize);
			}		
